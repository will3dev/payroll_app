...
contract RegistrationVerifier {
    ...
    uint256 constant ALPHA_X =
        15047588305025727542827205401986478227856375979297232401891932801054845387561;
    uint256 constant ALPHA_Y =
        16347384401987334882148596149938119238466874776676794551170631300991278036713;

    // Groth16 beta point in G2 in powers of i
    uint256 constant BETA_NEG_X_0 =
        5083682658493731049399182308644292031096942062225167095048736804163329349730;
    uint256 constant BETA_NEG_X_1 =
        1914880431605532606536731163315028547341395487907252696020873187436963674737;
    uint256 constant BETA_NEG_Y_0 =
        503897595580621925231505905955391595820768942068159826331209397456810815117;
    uint256 constant BETA_NEG_Y_1 =
        13373273730202340392264178991585050143336548942956500212995439877393946395506;

    // Groth16 gamma point in G2 in powers of i
    uint256 constant GAMMA_NEG_X_0 =
        18343431577243317842006600630212056928839235361933743456925964973944938710574;
    uint256 constant GAMMA_NEG_X_1 =
        9333869299160011750170662863756241797557266147790325724686435146895679109074;
    uint256 constant GAMMA_NEG_Y_0 =
        20131050806485081358209865595681558792490745884416024612483655014898309702712;
    uint256 constant GAMMA_NEG_Y_1 =
        7098191031463232427228841329818926402445823426640992994558289458635389265441;

    // Groth16 delta point in G2 in powers of i
    uint256 constant DELTA_NEG_X_0 =
        16898672073262269036996817577656235131212882465115009533331199582630830195331;
    uint256 constant DELTA_NEG_X_1 =
        1516529766348531748643668022614838790711264639980880443109253182236199498284;
    uint256 constant DELTA_NEG_Y_0 =
        449954803387909112442544142450001610207458807352296057413320468305692888644;
    uint256 constant DELTA_NEG_Y_1 =
        11937782636506028807463425074015887142165404284311071207322645982064967099234;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        15120677663363152202215055908582081858446178503160103004401976917215554773983;
    uint256 constant CONSTANT_Y =
        14949648228616539072638813664049379612111134243751963886712090369383954158648;
    uint256 constant PUB_0_X =
        11502194670213531986558096370202655134979216028858516807367998074304987471863;
    uint256 constant PUB_0_Y =
        3428903890498743465234668496618432303712045512438985364148912531857140210763;
    uint256 constant PUB_1_X =
        7426248568543101756643366803715733159329638843922299760805079606854921580563;
    uint256 constant PUB_1_Y =
        2441465173208186446845004262008391749408524957374265916532011626561169829123;
