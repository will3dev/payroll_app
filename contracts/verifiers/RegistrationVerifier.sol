...
contract RegistrationVerifier {
    ...
    uint256 constant ALPHA_X =
        18240323071222139981342083680753513701184513652459961812110458990866576740757;
    uint256 constant ALPHA_Y =
        11350597190396079621950772992255408702893805195773782546916291014665434250298;

    // Groth16 beta point in G2 in powers of i
    uint256 constant BETA_NEG_X_0 =
        8688034396419544048699031327555491498606878480382470874750684039055583778838;
    uint256 constant BETA_NEG_X_1 =
        18243831282642618997282554968177583276761132080307515358181804430691823513705;
    uint256 constant BETA_NEG_Y_0 =
        18492980651374315942872584873883773790351829728888779249729993069254128224247;
    uint256 constant BETA_NEG_Y_1 =
        14419539930399905527406527840848586642765670505634109822106749021526820415903;

    // Groth16 gamma point in G2 in powers of i
    uint256 constant GAMMA_NEG_X_0 =
        18346048560526522275371761093785425808459998518097860029332586366980376194844;
    uint256 constant GAMMA_NEG_X_1 =
        2023580981683794065926374850825063225511099081238488034829692560637057072319;
    uint256 constant GAMMA_NEG_Y_0 =
        15467871565461679859979171781996799541625741800895921946053230780117279170710;
    uint256 constant GAMMA_NEG_Y_1 =
        13186827117294558644143289107859320968244937598312033276667637850982539452243;

    // Groth16 delta point in G2 in powers of i
    uint256 constant DELTA_NEG_X_0 =
        14634114264415106687552807428597701495044239260447966555212564071704947472836;
    uint256 constant DELTA_NEG_X_1 =
        3489504119354248769515367775045366919249134587653328413387057399673939038195;
    uint256 constant DELTA_NEG_Y_0 =
        10031366728606431094110735440324417766444936096148574897871092975896559391917;
    uint256 constant DELTA_NEG_Y_1 =
        11262189822215534847882039233497960905320371783276811116223209601084473270957;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        2091310536458240247104828397695232491844980154702562366538038917335238984594;
    uint256 constant CONSTANT_Y =
        13166648724510274941611102983836546907468299102419440589724900887127901620375;
    uint256 constant PUB_0_X =
        15987627632645969869739225805787370649600071883001121987045889741265300523374;
    uint256 constant PUB_0_Y =
        10835253333798934128736880929837680157006051578219704770407871311810970409840;
    uint256 constant PUB_1_X =
        14247407253551361779848934973518162004758393648969982962106833792113299686579;
    uint256 constant PUB_1_Y =
        10829114555395471404624923593140666664924596146725162514037775727965240868724;
