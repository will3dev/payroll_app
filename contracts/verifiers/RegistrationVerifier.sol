...
contract RegistrationVerifier {
    ...
    uint256 constant ALPHA_X =
        6338393652636763028230279102486339342169729739075940562166750190932288584195;
    uint256 constant ALPHA_Y =
        6327036976278879164169980891695047387844073305565214134419701682004746996729;

    // Groth16 beta point in G2 in powers of i
    uint256 constant BETA_NEG_X_0 =
        3171988012098464723414589363898717186153577908777621066906244198235905459053;
    uint256 constant BETA_NEG_X_1 =
        5210824164322282103915522473273228642731200937287195256567758193681646095379;
    uint256 constant BETA_NEG_Y_0 =
        8018727638762870625395928226872867450055411619070855143490421295155730027448;
    uint256 constant BETA_NEG_Y_1 =
        833183363300648830411212604448274462025661930133913386910360704639426201959;

    // Groth16 gamma point in G2 in powers of i
    uint256 constant GAMMA_NEG_X_0 =
        3860111688496236353881231933966212829655028252421481618076518787234518946676;
    uint256 constant GAMMA_NEG_X_1 =
        13264428035597535222001402392002714010340946105225948516463956083521773850541;
    uint256 constant GAMMA_NEG_Y_0 =
        15658919462829326890487798229376962126334265978167654015375917267140811362726;
    uint256 constant GAMMA_NEG_Y_1 =
        1093163244666386564669117860143012371282629854565603493864646209500950152909;

    // Groth16 delta point in G2 in powers of i
    uint256 constant DELTA_NEG_X_0 =
        2784206995082301593512946875568087766846972400272055864083062595132397434206;
    uint256 constant DELTA_NEG_X_1 =
        1394578340849834722973452170532390483887356021971020654813113200841081165455;
    uint256 constant DELTA_NEG_Y_0 =
        13887367355407958012585793240872857144092974683425490142790636746340938486059;
    uint256 constant DELTA_NEG_Y_1 =
        19057585118072068432933144532161013725641778434767627921458593518374177672220;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        3819393509168909695148733671568748604559709184249269519341220209145777862723;
    uint256 constant CONSTANT_Y =
        7973257166142139096493817964782329333672597028199048778876228862808643975809;
    uint256 constant PUB_0_X =
        8792195952535837799794012163878529174483125851003409974774598332880314756323;
    uint256 constant PUB_0_Y =
        4836967468081989609846232748695789949493515546952496287518881836743596135908;
    uint256 constant PUB_1_X =
        1660513943785930760998486895171851618294108999969478385357818181610475188602;
    uint256 constant PUB_1_Y =
        5439215192002649402023212448866684268987684414569392033537617124747320249477;
